...
<script>
	...
	import PlantQuery from './imgs/components/PlantQuery'
	import PlantOperation from './imgs/components/PlantOperation'
	import PlantAddDialog from './imgs/components/PlantAddDialog'
	import PlantReviseDialog from './imgs/components/PlantReviseDialog'
	import PlantDetailDialog from './imgs/components/PlantDetailDialog'
	export default {
		data() {
			return {
				// table选中数据
