...
<script>
	...
	import PlantQuery from './plants/components/PlantQuery'
	import PlantOperation from './plants/components/PlantOperation'
	import PlantAddDialog from './plants/components/PlantAddDialog'
	import PlantReviseDialog from './plants/components/PlantReviseDialog'
	import PlantDetailDialog from './plants/components/PlantDetailDialog'
	export default {
		data() {
			return {
				// table选中数据
